                ...
                <form onSubmit={(e) => setDetailsHandler(e, title, amount, date)} className="expenses-filter-content flex flex-col gap-6 items-center">
                    <div className="expenses-filter-section flex justify-evenly w-full">
                        <div className="expenses-filter-title flex flex-col">
                            ...
                            <input onChange={e => setTitle(e.target.value)} type="text" id='filter-title' placeholder='please type the title' className='p-2 rounded-sm ' />
                        </div>
                        <div className="expenses-filter-date flex flex-col">
                            <label htmlFor="filter-date">Date</label>
                            <input onChange={e => setDate(e.target.value)} type="date" id='filter-dat' placeholder='please select date' className='p-2 rounded-sm ' />
                        </div>
                        <div className="expenses-filter-amount flex flex-col">
                            <label htmlFor="filter-title">Amount</label>
                            <input onChange={e => setAmount(e.target.value)} type="text" id='filter-title' placeholder='please type the amount' className='p-2 rounded-sm ' />
                        </div>
                    </div>
